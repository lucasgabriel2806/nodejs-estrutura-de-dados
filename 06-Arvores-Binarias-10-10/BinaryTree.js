...
class BinaryTree {
    ...
    constructor() {
        this.root = null; // Inicialmente, a árvore está vázia, então a raiz é null
    }
    ...
    // Percurso pór-ordem: visita a subárvore esquerda, a subárvore direita e o nó atual
    ...
    _removeNode(node, value) {
        ...
        if (value < node.value) {
            ...
            // Se o valor a ser removido é maior, continua na subárvore direira
            ...
            node.value = aux.value; // Substitui o valor do nó atual pelo valor mínimo econtrado
...
module.exports = BinaryTree; // Exportando com CommonJS